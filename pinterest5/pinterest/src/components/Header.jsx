...
export default function Header(){
    return(
        ...
        <div className="X-symbol">
            <svg className="symbol" viewBox="0 0 24 24" aria-hidden="true" aria-label="" role="img">
                <path
        ...
        <div className="logo">
            <svg className="img" viewBox="-3 -3 82 82">
                <path
        ...
        <div className="heading">Welcome to Pinterest</div>
